                    ...
                    <div class="details-box">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <?php endforeach; ?>
                                <div class="quote-properties">
                                    <label for="quote-guest-url">Send Whatssapp</label>
                                    <div class="input-group">
                                        <input hidden id="client-phone-id" value="<?php echo $quote->client_phone; ?>"></input>
                                        <textarea type="text" id="send-whatsapp-textarea" class="form-control" style="resize:none;"
                                               ><?php if($quote->quote_total!="0"){echo "Dear Client, Your payment of Rs. ". $quote->quote_total . " is pending. Please pay at earliest."; }?> </textarea>
