    ...
    <div id="content">
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
                ...
                <label for="payment_note" class="control-label">Receiver</label>
            </div>
            <div class="col-xs-12 col-sm-6">
                <input name="payment_note"
                          class="form-control" list="receivercustom" value="<?php echo $this->mdl_payments->form_value('payment_note', true); ?>"></input>
