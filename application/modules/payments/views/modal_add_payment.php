    ...
    $(function () {
        ...
        $('#btn_modal_payment_submit').click(function () {
            $.post("<?php echo site_url('payments/ajax/add'); ?>", {
                    ...
                    "custom[7]": $('#defaulted_payment_custom').val()
                },
                function (data) {
        ...
        <div class="modal-body">
            <form>
                ...
                <div class="form-group">
                                            ...
                                            <label for="payment_note">Receiver</label>

                    <div class="controls">
                        <input name="payment_note" id="payment_note" class="form-control" list="receivercustom" required   ></input>
                        <datalist id="receivercustom">
                            <option>Naresh Suthar</option>
                            <option>Shaitaan Singh</option>
                            <option>Heeralal Suthar</option>
                        </datalist>
                ...
                <div class="form-group">
                            <label for="custom[7]">Defaulted</label>
                        <div class="controls">
                                <select id="defaulted_payment_custom"
                            name="custom[7]"
                            class="form-control">
