                ...
                <div class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-6 col-md-offset-1">
                    <div class="details-box panel panel-default panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <label for="send-whatsapp-textarea">Send Whatsapp</label>
                                    <div class="input-group">
                                        <input hidden id="client-phone-id" value="<?php echo $invoice->client_phone; ?>"></input>
                                        <textarea type="text" id="send-whatsapp-textarea" class="form-control" style="resize:none;"
                                               >Dear Client, Your payment of Rs. <?php echo $invoice->invoice_balance; ?> is pending. Please pay at earliest.</textarea>
                                        <span class="input-group-addon to-clipboard cursor-pointer" onclick="sendwhatsapp()">
                                            <i class="fa fa-send fa-margin"></i>
                                        </span>
                                    </div>
                                </div>
